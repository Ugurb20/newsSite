 ...
 */
export declare module EventRegistryStatic {
    interface UsageInfo {
    ...
    type BaseConceptType = "person" | "loc" | "org" | "wiki";
    type ConceptType = "person" | "loc" | "org" | "wiki" | "entities" | "concepts" | "conceptClass" | "conceptFolder";
    type SourceType = "place" | "country";
    type ConceptClassType = "dbpedia" | "custom";
    type DataType = "news" | "pr" | "blog";
    /**
     * Options:
     *  * id (internal id),
     ...
     */
    type SortBy = "id" | "date" | "cosSim" | "rel" | "sourceImportance" | "sourceImportanceRank" | "sourceAlexaGlobalRank" | "sourceAlexaCountryRank" | "socialScore" | "facebookShares";
    interface SuggestConceptsArguments {
        /**
    ...
    interface SuggestCategoriesArguments {
        /**
         * page of the results (1, 2, ...)
         */
        page?: number;
    ...
    interface SuggestNewsSourcesArguments {
        /**
         * page of the results (1, 2, ...)
         */
        page?: number;
    ...
    interface SuggestSourceGroupsArguments {
        /**
         * page of the results (1, 2, ...)
         */
        page?: number;
    ...
    interface SuggestLocationsArguments {
        /**
    ...
    interface SuggestLocationsAtCoordinateArguments {
        /**
    ...
    interface SuggestSourcesAtPlaceArguments {
        /**
         * page of the results (1, 2, ...)
         */
        page?: number;
    ...
    interface SuggestConceptClassesArguments {
        /**
         * language in which the prefix is specified
         */
        lang?: string;
    ...
    interface SuggestCustomConceptsArguments {
        /**
         * language in which the prefix is specified
         */
        lang?: string;
    ...
    interface GetConceptUriArguments {
        /**
         * language in which the prefix is specified
         */
        lang?: string;
    ...
    interface GetLocationUriArguments {
        /**
         * language in which the prefix is specified
         */
        lang?: string;
    ...
    interface TopicPageAddConceptArguments {
        label?: string;
        conceptType?: string;
        required?: boolean;
        excluded?: boolean;
    }
    interface TopicPageAddKeywordArguments {
        required?: boolean;
        excluded?: boolean;
    }
    interface TopicPageAddCategoryArguments {
        required?: boolean;
        excluded?: boolean;
    }
    interface TopicPageAddSourceArguments {
        excluded?: boolean;
    }
    interface TopicPageAddSourceLocationArguments {
        excluded?: boolean;
    }
    interface TopicPageAddSourceGroupArguments {
        excluded?: boolean;
    }
    interface TopicPageArticles {
        /**
    ...
    namespace Correlations {
        ...
        interface TopCategoryArguments {
            /**
    ...
    namespace Analytics {
        interface TrainTopicOnTweetsArguments {
            /**
        ...
        interface TrainTopicGetTrainedTopicArguments {
            maxConcepts?: number;
            maxCategories?: number;
    ...
    namespace Info {
        interface GetSourceInfoArguments {
            /**
        ...
        interface GetConceptInfoArguments {
            /**
        ...
        interface GetCategoryInfoArguments {
            /**
    ...
    namespace Query {
        ...
        interface ComplexArticleQueryArguments {
            /**
        ...
        interface ComplexEventQueryArguments {
            minSentiment?: number;
            maxSentiment?: number;
        }
    }
    namespace QueryArticle {
        interface RequestArticleSimilarArticlesArguments {
            /**
        ...
        interface RequestArticleDuplicatedArticlesArguments {
            /**
             * page of the articles
             */
            page?: number;
    ...
    namespace QueryEvent {
         ...
         *  - facebookShares (shares on Facebook only)
         */
        type SortByOptions = "id" | "date" | "cosSim" | "sourceImportance" | "sourceImportanceRank" | "sourceAlexaGlobalRank" | "sourceAlexaCountryRank" | "socialScore" | "facebookShares";
        ...
        interface RequestEventArticlesArguments {
            /**
        ...
        interface RequestEventArticleUriWgtsArguments {
            /**
             * a single language or an array of languages in which to return the articles
             */
            lang?: string | string[];
        ...
        interface RequestEventArticleTrendArguments {
            /**
        ...
        interface RequestEventSimilarStoriesArguments {
            /**
             * array of concepts and their importance, e.g. [{ "uri": "http://en.wikipedia.org/wiki/Barack_Obama", "wgt": 100 }, ...]
             */
            conceptInfoList?: Array<{
    ...
    namespace QueryMentions {
        ...
        interface IteratorArguments extends Arguments {
        }
        interface RequestMentionsUriWgtListArguments {
            /**
        ...
        interface RequestMentionsConceptAggrArguments {
            /**
        ...
        interface RequestMentionsCategoryAggrArguments {
            mentionsSampleSize?: number;
            returnInfo?: ReturnInfo;
        }
        interface RequestMentionsSourceAggrArguments {
            sourceCount?: number;
            normalizeBySourceArts?: boolean;
            returnInfo?: ReturnInfo;
        }
        interface RequestMentionsKeywordAggrArguments {
            mentionsSampleSize?: number;
        }
        interface RequestMentionsConceptGraphArguments {
            /**
        ...
        interface RequestMentionsRecentActivityArguments {
            /**
    ...
    namespace QueryEvents {
        ...
        interface RequestEventsInfoArguments {
            /**
             * page of the results to return (1, 2, ...)
             */
            page?: number;
        ...
        interface RequestEventsUriListArguments {
            /**
             * page of the results to return (1, 2, ...)
             */
            page?: number;
        ...
        interface RequestEventsUriWgtListArguments {
            /**
             * page of the results to return (1, 2, ...)
             */
            page?: number;
        ...
        interface RequestEventsLocAggrArguments {
            /**
        ...
        interface RequestEventsLocTimeAggrArguments {
            /**
             * sample of events to use to compute the location aggregate
             */
            eventsSampleSize?: number;
        ...
        interface RequestEventsConceptAggrArguments {
            /**
             * number of top concepts to return
             */
            conceptCount?: number;
        ...
        interface RequestEventsConceptGraphArguments {
            /**
             * number of top concepts to return
             */
            conceptCount?: number;
        ...
        interface RequestEventsConceptMatrixArguments {
            /**
             * number of top concepts to return
             */
            conceptCount?: number;
        ...
        interface RequestEventsConceptTrendsArguments {
            /**
             * number of top concepts to return
             */
            conceptCount?: number;
        ...
        interface RequestEventsSourceAggrArguments {
            /**
             * number of top sources to return
             */
            sourceCount?: number;
        ...
        interface RequestEventsDateMentionAggrArguments {
            /**
        ...
        interface RequestEventsEventClustersArguments {
            /**
        ...
        interface RequestEventsRecentActivityArguments {
            /**
